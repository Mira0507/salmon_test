...
jpeg(file="Plots/sizefactors.jpeg", width=800, height=800, res=150)
...
jpeg(file="Plots/normfactors.jpeg", width=800, height=800, res=150)
print(normFactors_plot)
dev.off()

# Print the same plot with larger y-magnification in order to observe the box plot 
jpeg(file="Plots/normfactors_largemag.jpeg", width=800, height=800, res=150)
normFactors_plot + 
    ylim(0.5, 1.5)
dev.off()
...
jpeg(file="Plots/samplePCA.jpeg", width=800, height=800, res=150)
...
jpeg(file="Plots/corheatmap_tpm.jpeg", width=1000, height=800, res=150)
# TPM
...
jpeg(file="Plots/corheatmap_counts.jpeg", width=1000, height=800, res=150)
# Counts
...
for (x in TvC) {
    ...
    jpeg(file=paste0("Plots/dispersion_", x, ".jpeg"), 
...
jpeg(file="Plots/shrinkage_TPM.jpeg", width=1200, height=800, res=150)
grid.arrange(MA[[1]], shr_MA[[1]], nrow=1)
dev.off()


# Counts with or without shrinkage
jpeg(file="Plots/shrinkage_counts.jpeg", width=1200, height=800, res=150)
...
jpeg(file="Plots/FDR_distribution.jpeg", width=1000, height=800, res=150)
ggplot(res,
...
jpeg(file="Plots/volcano.jpeg", width=1200, height=800, res=150)
Volcano_fn(res)
dev.off() 
...
jpeg(file="Plots/volcano_with_genes.jpeg", width=1200, height=800, res=150)
...
jpeg(file="Plots/l2fc_distribution.jpeg", width=1000, height=800, res=150)
...
for (x in TvC) {
    ...
    jpeg(file=paste0("Plots/profile_lowfdr_", x, ".jpeg"), 
    ...
    jpeg(file=paste0("Plots/profile_highfold_", x, ".jpeg"), 
         width=1200, height=1200, res=150)
...
jpeg(file="Plots/NAs.jpeg", width=800, height=800, res=150)
...
jpeg(file="Plots/FDR_rank.jpeg", width=1000, height=800, res=150)
# Ranked by FDR
compareRanks_fn(combineTable_fn(FDRrankList), 
                "FDR")
dev.off()

jpeg(file="Plots/lfc_rank.jpeg", width=1000, height=800, res=150)
...
jpeg(file="Plots/UPlfc_rank.jpeg", width=1000, height=800, res=150)
...
jpeg(file="Plots/DOWNlfc_rank.jpeg", width=1000, height=800, res=150)
...
jpeg(file="Plots/FDRdiff_rank.jpeg", width=1000, height=800, res=150)
# Ranked by FDR
...
jpeg(file="Plots/lfcdiff_rank.jpeg", width=1000, height=800, res=150)
# Ranked by absolute fold change 
RankdiffOverMean_fn(combineTable_fn(lfcList), 
                "Absolute Log2FoldChange")
dev.off()

jpeg(file="Plots/UPlfcdiff_rank.jpeg", width=1000, height=800, res=150)
# Ranked by magnitude of positive fold change
RankdiffOverMean_fn(combineTable_fn(UPlfcList), 
                "Log2FoldChange (Increased)")
dev.off()

jpeg(file="Plots/DOWNlfcdiff_rank.jpeg", width=1000, height=800, res=150)
# Ranked by magnitude of negative fold change
...
jpeg(file="Plots/upset.jpeg", width=1000, height=800, res=150)
